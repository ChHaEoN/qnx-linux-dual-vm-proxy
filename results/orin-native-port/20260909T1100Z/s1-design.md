...
**2026-09-15 (owner):** accepted with every recommendation; the decisions are recorded in §16.15's Taken block. **2026-09-16:** the startup is built on the PC and its pin moved; the board images are regenerated on the new pin, and nothing of revision 4 has run on the board.
